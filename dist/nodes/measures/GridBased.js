...
const registerGridBasedMeasureDelegate = ({ className, label, }) => {
...
gridBasedMeasuresScaffold.forEach((_a) => {
    var props = __rest(_a, []);
    return registerGridBasedMeasureDelegate(props);
});
//# sourceMappingURL=GridBased.js.map